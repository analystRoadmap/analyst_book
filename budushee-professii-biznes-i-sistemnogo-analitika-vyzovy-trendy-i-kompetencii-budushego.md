...
### Книги о будущем профессии
- **"Технологии которые изменят мир"** - Сальвагор Лхори
- **"AI Superpowers"** - Кайфу Ли (о будущем ИИ)
- **"The Future of Work"** - Джакоб Морган
- **"Exponential Organizations"** - Салим Исмаил

### AI и LLM инструменты для аналитиков
- ChatGPT/Claude - для генерации требований и анализа
- Microsoft Copilot for Business Process Management
- IBM watsonx Requirements Assistant
- Atlassian Rovo - помощник в оформлении требований

### Мониторинг трендов
- TechCrunch - технологические новости
- Harvard Business Review - тренды в бизнесе
- Gartner Reports - аналитика рынка
- LinkedIn - следите за лидерами в области

### Развитие критических навыков
- Курсы по Prompt Engineering
- AI Literacy программы
- Lean методология и их эволюция
- Агайл и гибридные методологии
