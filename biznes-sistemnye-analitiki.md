...
### Книги по роли аналитика
- **"Интеллектуальный аналитик"** - Морин Морис (Getting More)
- **"Бизнес-анализ для достижения совершенства"** - IIBA BABOK v3
- **"Requirement Engineering для профессионалов"** - Петер Ауэр
- **"The Art of Business Analysis"** - Andy Crowe
...
- **IIBA** (International Institute of Business Analysis) - сертификация CCBA, CBAP
- **Project Management Institute (PMI)** - управление проектами
- **Agile Alliance** - сертификация Scrum и Agile подходов

### Онлайн-ресурсы
- IIBA.org - официальный сайт
- BusinessAnalystLearning.com - материалы по анализу
- YouTube каналы по бизнес-анализу
- Курсы на Coursera, Udemy, LinkedIn Learning
