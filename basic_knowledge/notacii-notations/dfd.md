...
{% hint style="warning" %}
**Legacy-нотация.** DFD редко используется в современных проектах. Для описания потоков данных в новых проектах рекомендуется обратить внимание на [C4 Model](https://c4model.com/) (уровни Context и Container) или [ArchiMate](https://www.opengroup.org/archimate-forum). Тем не менее, DFD остаётся полезным для понимания наследуемых (legacy) систем и классического системного анализа.
{% endhint %}
