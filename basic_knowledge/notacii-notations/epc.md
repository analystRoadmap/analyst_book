...
{% hint style="warning" %}
**Legacy-нотация.** EPC тесно связана с экосистемой SAP/ARIS и редко применяется за её пределами в современных проектах. Для моделирования бизнес-процессов сегодня чаще используется [BPMN](bpmn.md). Для описания корпоративной архитектуры рекомендуется [ArchiMate](https://www.opengroup.org/archimate-forum). Тем не менее, EPC остаётся актуальной в контексте SAP-проектов и анализа наследуемых систем.
{% endhint %}
