...
На основе собранных и проанализированных требований аналитик разрабатывает план проекта, который включает в себя описание этапов проекта, задач (преобразование бизнес-требований в постановки задач на разработку), сроков и ресурсов, необходимых для его выполнения. Он также определяет риски и способы их управления.
